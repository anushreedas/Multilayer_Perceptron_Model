...
trainingfilenames = {'images' : 'data/train-images-idx3-ubyte' ,'labels' : 'data/train-labels-idx1-ubyte'}
testfilenames = {'images' : 'data/t10k-images-idx3-ubyte' ,'labels' : 'data/t10k-labels-idx1-ubyte'}
...
test_labels_array.tofile('test_labels_array.dat')
test_images_array.tofile('test_images_array.dat')
train_labels_array.tofile('train_labels_array.dat')
train_images_array.tofile('train_images_array.dat')
